            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/lsapp/public/dashboard">Dashboard</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/lsapp/public/posts">Posts</a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navba-right">
                        <a class="nav-link" href="http://localhost/lsapp/public/posts/create">Create Posts</a>
